...
export class AuthService {
   ...
   */
  async login(user: User, locationData?: { latitude: number; longitude: number }) {
    ...
    try {
      ...
      // Si des données de localisation sont fournies, les enregistrer
      if (locationData) {
        await this.trackingService.updateUserLocation(user.id, {
