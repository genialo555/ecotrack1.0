    ...
    <div className="drawer">
      ...
      <div className="drawer-content flex flex-col">
        ...
        <div className="navbar bg-base-100 sticky top-0 z-50 border-b border-base-200">
          ...
          <div className="flex-1">
            <a className="btn btn-ghost normal-case text-xl text-primary">EcoTrack</a>
          </div>
          <div className="flex-none">
        ...
        <footer className="footer footer-center p-4 bg-base-100 text-base-content border-t border-base-200">
          <aside>
            <p>Copyright 2024 - All rights reserved by EcoTrack</p>
          </aside>
        </footer>
      </div>
      ...
      <div className="drawer-side">
        ...
        <ul className="menu p-4 w-80 min-h-full bg-base-100 text-base-content">
          <li><a href="/" className="text-lg">Accueil</a></li>
          <li><a href="/dashboard" className="text-lg">Dashboard</a></li>
          <li><a href="/login" className="text-lg">Connexion</a></li>
        </ul>
      </div>
    </div>
  );
